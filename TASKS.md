...
### V1.0 à V1.5 - Fondations et UX
- [x] **Système d'Achat, Collection & Dashboard**
- [x] **Évolution, Succès, Notifications Toast & Filtres Avancés**

### V1.6 - Interactions, Équipe & Économie Dynamique
- [x] **Deck Building (Squad) :** Création d'une équipe de 6 Pokémon champions avec badge dédié.
- [x] **Marché Dynamique :** Fluctuation automatique des prix de revente toutes les 60 secondes.
- [x] **Historique des Transactions :** Log complet des achats, ventes et évolutions dans le Dashboard.
